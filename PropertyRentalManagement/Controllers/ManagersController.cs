...
namespace PropertyRentalManagement.Controllers
{
    ...
    public class ManagersController : Controller
    {
        ...
        public ManagersController(PropertyRentalManagementDbContext context)
        {
            _context = context;
        }
        ...
        {
            var propertyRentalManagementDbContext = _context.Users.Include(u => u.Role).Where((u) => u.Role.Role == "Manager");
        ...
        {
            // Initialize a query to fetch all users with the role of "Manager"
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("UserId,Username,FirstName,LastName,Email,PhoneNumber,Password,RoleId")] User user)
        {
